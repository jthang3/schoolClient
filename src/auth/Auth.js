    ...
    const protectView = ()=>{
        return(
            <Switch>
                ...
                <Route exact path = "/Login1"><Login updatePerson = {props.updatePerson} home = {props.home} updateDisplay = {props.updateDisplay} updateToken = {props.updateToken} updateLog = {props.updateLog}/></Route>
            </Switch>
        )
    }
    return(
